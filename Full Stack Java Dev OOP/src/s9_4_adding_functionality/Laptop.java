...
public class Laptop {
	...
	// creating method for functionality
	/*// So we are like accessing the object and we are retrieving the information
	which is there in the object twice.
	First of all, we are accessing the object
	in order to set the frequency, right?
	And as soon as we are calling in this method, we are in need of accessing
	the Max frequency of the processor.  */
